package com.mvvmdemo.www.library_common.http;

import android.support.annotation.NonNull;
import android.text.TextUtils;
import android.util.Log;

import com.mvvmdemo.www.library_common.http.interceptor.HttpLogInterceptor;
...
public class HttpManager {
    ...
    private Retrofit getRetrofit(String baseUrl, OkHttpClient client) {
        return getRetrofit(baseUrl, client, GsonConverterFactory.create());
    }
